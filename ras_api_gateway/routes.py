...
RM_CE_SERVICE_PORT = os.getenv('RM_COLLECTIONEXERCISE_SERVICE_PORT', 8145)
...
RM_SURVEY_SERVICE_PORT = os.getenv('RM_SURVEY_SURVEY_PORT', 8080)
...
RM_NOTIFY_GATEWAY_SERVICE_PORT = os.getenv('RM_NOTIFY_GATEWAY_SERVICE_PORT', 8281)
...
RM_ACTION_SERVICE_PORT = os.getenv('RM_ACTION_SERVICE_PORT', 8151)
...
RM_SAMPLE_SERVICE_PORT = os.getenv('RM_SAMPLE_SERVICE_PORT', 8160)
...
RAS_SECURE_MESSAGING_SERVICE_PORT = os.getenv('RAS_SECURE_MESSAGING_SERVICE_PORT', 8003)
